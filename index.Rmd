...
cover-image: img/omegat_logo.jpg
---
...
Welcome to the OmegaT bootcamp :-)

[//]: # ![](img/omegat_logo.jpg)

This is a self-paced [OmegaT](https://omegat.org/) user guide for language experts and project managers, brought to you by [cApStAn](https://www.capstan.be).
...
* How can I insert an image before the first #header/title?
* Is it possible to have an index page without a header?
* Make size of title bigger
* how do I customize twitter and facebook buttons? can I add linkedin?
* Is it possible to include/import .Rmd files so as to reuse one same file in different places?
